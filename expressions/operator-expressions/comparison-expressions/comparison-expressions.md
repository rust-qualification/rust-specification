...
**2.4.3.7.3.** `>=` <!-- 8c9f42c4-79b2-4017-ace4-81d08549c196 --> :
...
**2.4.3.7.4.** `<` <!-- 4e4cbbd1-2bb4-40e4-b8ad-394526322e95 --> :
...
**2.4.3.7.5.** `<=` <!-- 02e86ee3-3ff4-4756-b7fb-d82534a35556 --> :
...
**2.4.3.7.6.** `!=` <!-- ac7610ba-251c-4854-bffc-3c0b9f8fdb7c --> :
...
**2.4.3.8.** <!-- e420b920-c632-48bb-ab6c-e3f069f3b893 --> The following operations are defined for [bool](../../../types/bool/bool.md#bool): <a name="comparison-tables"></a>
### Equality
...
**2.4.3.9.** <!-- 776d385c-c14e-4a68-a8ad-bb4170d0a41d --> ` a != b is the same as !(a == b)` \
**2.4.3.10.** <!-- 7eb21a55-d01d-4115-9c46-1d733586abeb --> ` a >= b is the same as a == b | a > b` \
**2.4.3.11.** <!-- d2b1ae2b-5b9e-4133-852c-a0433a2d3ca5 --> ` a < b is the same as !(a >= b)` \
...
**2.4.3.14.** <!-- 0db0958b-439a-43ce-b4ef-4e32d0d3a3e7 --> The evaluation of a `greater-than` expression has the following steps:
...
**2.4.3.15.** <!-- 9f1414ba-1b4b-4d7f-a1f0-a092426a27fe --> The evaluation of a `greater-than-or-equals` expression has the following steps:
...
**2.4.3.16.** <!-- aa51863d-72de-461d-a746-0e1048dc52a7 --> The evaluation of a `less-than` expression has the following steps:
...
**2.4.3.17.** <!-- 5cadfee2-3331-44f2-a8f3-64264c74e81c --> The evaluation of a `less-than-or-equals` expression has the following steps:
...
**2.4.3.18.** <!-- 5aa7b5c9-8c01-41f1-9b9b-3cf089141848 --> The evaluation of an `inequality` expression has the following steps:
