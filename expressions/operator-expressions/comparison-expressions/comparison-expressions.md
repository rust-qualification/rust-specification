...
Some specific comparison rules for different primitive types:
- 2.4.3.4. <!-- 17b4e671-32b1-4dea-bd1c-8692e6bc6eb9 --> `Chars` are compared lexicographically.
- 2.4.3.5. <!-- c0bf0f1e-01cf-4657-9261-fd2dd4fef6db --> `Strings` are compared lexicographically, character by character
...
2.4.3.10. `==` <!-- 04aa0dda-0706-44cb-9ab3-7945aeb58bb3 --> :
...
2.4.3.11. `>` <!-- 9289fb9d-67b5-4f30-bf22-2b9d646677aa --> :
...
2.4.3.12. `>=` <!-- 8c9f42c4-79b2-4017-ace4-81d08549c196 --> :
...
2.4.3.13. `<` <!-- 4e4cbbd1-2bb4-40e4-b8ad-394526322e95 --> :
...
2.4.3.14. `<=` <!-- 02e86ee3-3ff4-4756-b7fb-d82534a35556 --> :
...
2.4.3.15. `!=` <!-- ac7610ba-251c-4854-bffc-3c0b9f8fdb7c --> :
...
2.4.3.16. <!-- e420b920-c632-48bb-ab6c-e3f069f3b893 --> The following operations are defined for [bool](../../../types/bool/bool.md#bool): <a name="comparison-tables"></a>
### Equality
...
2.4.3.17. <!-- 776d385c-c14e-4a68-a8ad-bb4170d0a41d --> ` a != b is the same as !(a == b)` \
2.4.3.18. <!-- 7eb21a55-d01d-4115-9c46-1d733586abeb --> ` a >= b is the same as a == b | a > b` \
2.4.3.19. <!-- d2b1ae2b-5b9e-4133-852c-a0433a2d3ca5 --> ` a < b is the same as !(a >= b)` \
2.4.3.20. <!-- 4c3ff96c-5612-4e32-baf8-3b97aa49a52f --> ` a <= b is the same as a == b | a < b` 

### Runtime Semantics
2.4.3.21. <!-- d6922c6a-99f3-4a86-880d-30ca8c6a6ffd --> The evaluation of an `equals` expression has the following steps:
...
2.4.3.22. <!-- 0db0958b-439a-43ce-b4ef-4e32d0d3a3e7 --> The evaluation of a `greater-than` expression has the following steps:
...
2.4.3.23. <!-- 9f1414ba-1b4b-4d7f-a1f0-a092426a27fe --> The evaluation of a `greater-than-or-equals` expression has the following steps:
...
2.4.3.24. <!-- aa51863d-72de-461d-a746-0e1048dc52a7 --> The evaluation of a `less-than` expression has the following steps:
...
2.4.3.25. <!-- 5cadfee2-3331-44f2-a8f3-64264c74e81c --> The evaluation of a `less-than-or-equals` expression has the following steps:
...
2.4.3.26. <!-- 5aa7b5c9-8c01-41f1-9b9b-3cf089141848 --> The evaluation of an `inequality` expression has the following steps:
