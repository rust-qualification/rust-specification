...
In this repository, I present a language specification for selected features of Rust, that serves as a proof-of-concept, demonstrating best practices for a compiler qualification process. This specification draws inspiration from the [Ferrocene](https://github.com/ferrocene/specification) language specification and the [Rust Reference](https://github.com/rust-lang/reference), but it includes additional information that were considered important. It also incorporates some fixes that have been merged into the Ferrocene and Rust Reference repositories.
